...
function App() {
  ...
  return (
    <div className="App">
      ...
      <div className="heading2"><p><b>Simple 15 Days To Get Your First Job</b></p></div>
      <div className="headertop">
        ...
        <div>
          ...
          src={bgelement1}></img>
          <div style={{marginTop:'40px'}} className="heading5"><p style={{fontSize:'50px'}}><b> How we Make a Difference </b></p></div>
