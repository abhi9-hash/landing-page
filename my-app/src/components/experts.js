...
function Experts() {
    return (
      ...
      <div><img className="img9" src={bgelement5} style={{maxWidth:'45vw',position:'absolute', marginTop:'-15rem',marginLeft:'7%',zIndex:'-1'}}></img> 
          </div>

     <div className="grid5">
        <div className="grid15" >
          <div className="div">
            <div style={{height:'12rem',width:'12rem',borderRadius:'50%',backgroundColor:'white', display:'flex',justifyContent:'center', alignItems:'center',position:'absolute',  marginBottom:'25rem'}}><img style={{height:'12rem',width:'12rem',borderRadius:'50%'}}src={expert1}></img>
            </div>
            <h2 style={{
  ...
  fontFamily: 'Montserrat, sans-serif'}}><a  color="white" href="https://www.linkedin.com/in/akansha-bajaj-022a75113"><i style={{transform:'scale(1.5)'}} class="linkedin alternate icon"></i></a> </h5>
            ...
            <div className="div">
            <div style={{height:'12rem',width:'12rem',borderRadius:'50%',backgroundColor:'white', display:'flex',justifyContent:'center', alignItems:'center',position:'absolute',  marginBottom:'25rem'}}><img style={{height:'12rem',width:'12rem',borderRadius:'50%'}}src={expert2}></img>
            </div>
            <h2 style={{
  ...
  fontFamily: 'Montserrat, sans-serif'}}><a color="white" href="https://www.linkedin.com/in/02pankaj93/"><i style={{transform:'scale(1.5)'}}  class="linkedin alternate icon"></i></a></h5>
            ...
            <div className="div">
            <div style={{height:'12rem',width:'12rem',borderRadius:'50%',backgroundColor:'white', display:'flex',justifyContent:'center', alignItems:'center',position:'absolute',  marginBottom:'25rem'}}>< img style={{height:'12rem',width:'12rem',borderRadius:'50%'}}src={expert3}></img>
            </div>
            <h2 style={{
